...
i3 윈도우 매니저는 C언어로 개발되었고, 비슷한 종류의 다른 타일링 윈도우 매니저들보다 비교적 최근에 나왔다는 특성이 있다.  때문에 부가적인 기능들이 대체로 잘 갖추어져 있고, 빠른 응답속도와 가벼운 크기를 잘 유지한다.

## i3-gaps

최근에는 i3에서 포크하여, 윈도우간에 갭을 줄 수 있는 옵션을 추가한 i3-gaps가 오리지널보다 더 많이 사용되는 것 같다.

## Rounded i3-gaps

여기서 한발 더 나아가, 윈도우 코너 부분에 라운드를 줘서 좀 더 예쁘게 수정한 Rounded i3-gaps도 있다.
